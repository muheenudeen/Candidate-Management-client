...
//                     alt="Profile"
//                     className="w-64 h-64 rounded-full object-cover border-4 border-blue-500 shadow-lg mx-auto"
//                   />
...
//                     className="mt-4 w-full px-6 py-3 bg-blue-600 text-white text-lg font-semibold rounded-lg hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition duration-150 ease-in-out"
...
//                 <h1 className="text-4xl font-bold mb-6 text-gray-800">Welcome, {candidateData.name}</h1>
...
//                           <button
//                             type="submit"
//                             className="mt-2 px-4 py-2 bg-blue-600 text-white text-sm font-medium rounded-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition duration-150 ease-in-out"
//                             disabled={isUploading}
//                           >
...
//               <div className="bg-gradient-to-br from-blue-400 to-blue-600 rounded-xl p-6 text-white shadow-lg transform hover:scale-105 transition duration-200">
...
//                 <div className="text-blue-200">Submitted</div>
//               </div>
//               <div className="bg-gradient-to-br from-green-400 to-green-600 rounded-xl p-6 text-white shadow-lg transform hover:scale-105 transition duration-200">
...
//                 <div className="text-green-200">Scheduled</div>
//               </div>
//               <div className="bg-gradient-to-br from-purple-400 to-purple-600 rounded-xl p-6 text-white shadow-lg transform hover:scale-105 transition duration-200">
...
//                 className="w-full px-6 py-3 bg-green-600 text-white text-lg font-semibold rounded-lg hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 transition duration-150 ease-in-out"
//               >
